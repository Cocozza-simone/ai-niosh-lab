...
class TestNIOSHCalculatorBounds(unittest.TestCase):
    ...
    def test_am_bounds(self):
        # A > 135 should return 0
        self.assertEqual(self.calc._am(136.0), 0.0)
        # A <= 135 should be valid
        self.assertGreater(self.calc._am(135.0), 0.0)
        self.assertEqual(self.calc._am(0.0), 1.0)
